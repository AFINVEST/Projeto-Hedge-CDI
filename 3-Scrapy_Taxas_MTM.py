...
MATRIZ_ORIG_XLSX = Path("Dados/Matriz de Curvas 28082026.xlsx")
...
SPECIFIC_DATE = pd.Timestamp("2026-08-31")            # <- Data que será inserida no campo #Data quando o toggle estiver ligado
