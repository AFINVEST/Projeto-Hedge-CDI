...
MATRIZ_ORIG_XLSX = Path("Dados/Matriz de Curvas 05062026.xlsx")
...
SPECIFIC_DATE = pd.Timestamp("2026-06-08")            # <- Data que será inserida no campo #Data quando o toggle estiver ligado
